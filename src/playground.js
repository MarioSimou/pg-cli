...
// console.log(p1.select(p1.columns.username.as('user_name'), p1.columns.email.as('user_email')).from({ table : 'random' , schema: "public"}).where(p1.columns.email.equals(10)))
